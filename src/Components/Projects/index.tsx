    ...
    return (
        <section className={`${styles.projects} ${ isVisible ? styles.isVisible : null}`} id="projects" ref={domRef}>
            ...
            <div className={styles.container}>
                ...
                <Project name="Forkify" image={forkifyImg} description="A recipe application" stacks={["HTML", "CSS", "JAVASCRIPT(MVP)"]} liveLink="https://forkify-bobola.netlify.app/" codeLink="https://github.com/Adebobola01/forkify"/>
            </div>
        </section>
    )
}
